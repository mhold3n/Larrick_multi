...
def get_gear_schema_v1() -> FeatureSchema:
    ...
    feats = [
        "gear_base_radius",
        "gear_c1", "gear_c2", "gear_c3", "gear_c4", "gear_c5", "gear_c6", "gear_c7"
    ]
    targets = ["delta_loss"]
    return FeatureSchema(feature_names=feats, target_names=targets, description="Gear Loss Residual")
...
def get_scavenge_schema_v1() -> FeatureSchema:
    ...
    return FeatureSchema(feature_names=feats, target_names=targets, description="Scavenge Efficiency Residual")
