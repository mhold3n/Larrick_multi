...
from larrak2.promote.archive import ArchiveBundle, ArchiveRecord, save_npz, save_meta
...
class StagedWorkflow:
    ...
    def run_stage1(self, pop_size: int, n_gen: int) -> ArchiveBundle:
        ...
        save_npz(self.outdir, bundle, "stage1", 
                 extra_arrays={"n_evals": np.array([problem.n_evals])})
    ...
    def run_stage3(self, seed_bundle: ArchiveBundle, pop_size: int, n_gen: int) -> ArchiveBundle:
        ...
        initial_pop = Population.new("X", X_seed)
        ...
        save_npz(self.outdir, bundle, "stage3", 
                 extra_arrays={"n_evals": np.array([problem.n_evals])})
