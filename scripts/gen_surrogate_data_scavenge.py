...
def main():
    ...
    parser.add_argument("--template", type=str, default="templates/scavenge_case", help="OpenFOAM template dir")
    ...
    for i in range(args.n_samples):
        ...
        if args.use_sim and runner:
            ...
            from larrak2.core.evaluator import evaluate_candidate, EvalContext
            # Construct context
