...
def train_models(X: np.ndarray, y: np.ndarray) -> tuple[BaseEstimator, dict]:
    ...
    metrics = {"mse_eff": mse[0], "mse_loss": mse[1], "r2_eff": r2[0], "r2_loss": r2[1]}
...
def main():
    ...
    parser.add_argument(
        "--data", type=str, default="data/surrogate_v1/training_data.npz", help="Input data"
    )
    parser.add_argument(
        "--outdir", type=str, default="models/surrogate_v1", help="Output directory"
    )
