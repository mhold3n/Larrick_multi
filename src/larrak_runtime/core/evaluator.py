...
def evaluate_candidate(x: np.ndarray, ctx: EvalContext) -> EvalResult:
    ...
    # ===================================================================
    from larrak_runtime.machining.cost_model import (
        calculate_tolerance_budget,
        calculate_tooling_cost,
    )
    ...
    if has_profiles:
        ...
        from larrak_runtime.realworld.surrogates import PhaseResolvedResult
