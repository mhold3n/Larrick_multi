...
DEFAULT_SCALES: dict[str, float] = {
    ...
    "thermo_burn_cap_min": 1.0,
    "thermo_trapped_mass_min": 1.0e-3,
    "thermo_scavenging_efficiency_min": 1.0,
    "thermo_residual_fraction_max": 1.0,
    "thermo_delivered_vapor_fraction_min": 1.0,
    "thermo_mixture_inhomogeneity_max": 1.0,
    "thermo_wall_film_fraction_max": 1.0,
    "thermo_ignitability_margin_min": 1.0,
    "thermo_preignition_margin_min": 1.0,
...
DEFAULT_KIND: dict[str, str] = {
    ...
    "thermo_burn_cap_min": "hard",
    "thermo_trapped_mass_min": "hard",
    "thermo_scavenging_efficiency_min": "hard",
    "thermo_residual_fraction_max": "hard",
    "thermo_delivered_vapor_fraction_min": "hard",
    "thermo_mixture_inhomogeneity_max": "hard",
    "thermo_wall_film_fraction_max": "hard",
    "thermo_ignitability_margin_min": "hard",
    "thermo_preignition_margin_min": "hard",
...
DEFAULT_REASON: dict[str, str] = {
    ...
    "thermo_burn_cap_min": "burn-cap viability below minimum stable-combustion threshold",
    "thermo_trapped_mass_min": "trapped intake mass below minimum viable charge",
    "thermo_scavenging_efficiency_min": "scavenging efficiency below stable-combustion floor",
    "thermo_residual_fraction_max": "residual fraction exceeds stable-combustion ceiling",
    "thermo_delivered_vapor_fraction_min": "delivered vapor fraction below chemistry-informed minimum",
    "thermo_mixture_inhomogeneity_max": "mixture inhomogeneity exceeds chemistry-informed ceiling",
    "thermo_wall_film_fraction_max": "wall-film carryover exceeds chemistry-informed ceiling",
    "thermo_ignitability_margin_min": "ignitability margin at spark below minimum",
    "thermo_preignition_margin_min": "preignition margin before spark below minimum",
...
THERMO_CONSTRAINTS_FID0 = [
    ...
    "thermo_pmax_norm",
    "thermo_burn_cap_min",
    "thermo_trapped_mass_min",
    "thermo_scavenging_efficiency_min",
    "thermo_residual_fraction_max",
    "thermo_delivered_vapor_fraction_min",
    "thermo_mixture_inhomogeneity_max",
    "thermo_wall_film_fraction_max",
    "thermo_ignitability_margin_min",
    "thermo_preignition_margin_min",
