...
Usage:
    python -m larrak_optimization.cli.run_pareto --pop 64 --gen 50 --rpm 3000 --torque 200
    python -m larrak_optimization.cli.run_pareto --fidelity 1 --seed 123 --outdir ./results
...
from larrak_runtime.architecture.contracts import CONTRACT_VERSION, active_contract_tracer
from larrak_runtime.core.archive_io import save_archive
from larrak_runtime.core.constants import MODEL_VERSION_GEAR_V1, MODEL_VERSION_THERMO_V1
from larrak_runtime.core.constraints import get_constraint_names, get_constraint_scales
from larrak_runtime.core.encoding import ENCODING_VERSION
from larrak_runtime.core.types import BreathingConfig
...
def main(argv: list[str] | None = None) -> int:
    ...
    from larrak_optimization.adapters.pymoo_problem import ParetoProblem
