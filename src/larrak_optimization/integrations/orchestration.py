"""Optimization-side orchestration adapter bindings."""
...
from larrak_optimization.adapters.casadi_refine import RefinementMode, refine_candidate
...
class CasadiSolverAdapter:
    """Uses `larrak_optimization.adapters.casadi_refine.refine_candidate` for local solves."""
