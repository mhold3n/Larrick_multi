...
from larrak_optimization.pipelines.principles_core import (
    PRINCIPLES_OBJECTIVE_NAMES,
    expand_reduced_vector,
)
from larrak_runtime.core.constants import RATIO_SLOPE_LIMIT_FID1
...
from larrak_runtime.core.encoding import decode_candidate
from larrak_runtime.core.evaluator import evaluate_candidate
from larrak_runtime.core.types import EvalContext
from larrak_runtime.gear.litvin_core import eval_gear
from larrak_runtime.gear.manufacturability_limits import (
    ManufacturingProcessParams,
    compute_manufacturable_ratio_rate_limits,
)
from larrak_runtime.machining.cost_model import calculate_tolerance_budget, calculate_tooling_cost
from larrak_runtime.realworld.constraints import compute_realworld_constraints
from larrak_runtime.realworld.life_damage import (
    compute_life_damage_scalar_proxy_10k,
    get_route_cleanliness_proxy,
    get_sigma_ref_for_route,
)
from larrak_runtime.realworld.surrogates import (
    RealWorldSurrogateParams,
    _material_from_level,
    evaluate_realworld_surrogates,
)
from larrak_runtime.surrogate.machining_inference import get_machining_engine
from larrak_runtime.thermo.motionlaw import eval_thermo
...
def evaluate_principles_proxy(
    ...
    *,
    ...
    try:
        ...
        from larrak_runtime.cem.material_db import get_material
