...
from larrak_optimization.optimization.candidate_store import CandidateStore
...
from larrak_optimization.pipelines.principles_search import (
    PrinciplesDiagnosis,
    search_principles_region,
)
...
def synthesize_principles_frontier(
    *,
    ...
    G_region = (
        ...
        if region_indices
        else np.zeros((0, n_constraints), dtype=np.float64)
    )
    Z_region = (
