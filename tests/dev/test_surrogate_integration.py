...
def test_engine_load_legacy_dict(temp_model_dir, monkeypatch):
    ...
    artifact = {"model": MockModel(), "schema_hash": schema._hash, "meta": {}}
    ...
    # Mock registry
    monkeypatch.setattr(
        "larrak2.surrogate.registry.ModelRegistry.get_path",
...
def test_engine_reject_mismatch(temp_model_dir, monkeypatch):
    ...
    artifact = {"model": MockModel(), "schema_hash": "badhash123", "meta": {}}
