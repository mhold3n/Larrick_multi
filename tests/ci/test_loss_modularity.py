...
def test_loss_components_sum():
    ...
    total, profile, diag = total_loss(
        theta, r_planet, rho_c, omega_rpm=3000, torque=200, enable_windage=True
    )
    mesh_only, _, diag_mesh = total_loss(
        theta, r_planet, rho_c, omega_rpm=3000, torque=200, enable_windage=False
    )
